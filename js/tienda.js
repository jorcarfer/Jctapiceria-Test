...
function agregarProducto(event) {
   ...
   /* for (let i = 0; i < carrito.length; i++) {
    ...
    alert("Usted agrego: " + producto.nombre);

    if(confirm("Desea seguir comprando?")==false){

        alert("Esta siendo redirigido")
        window.location.href = "carrito.html"; //muestra el resultado en la pagina
